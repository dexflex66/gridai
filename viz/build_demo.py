  ...
  <div class="main-layout" id="mainLayout">
    ...
    <div class="panel" id="gossipPanel">
      ...
      <div class="tradeoff-note">
        ...
        <span class="tradeoff-cost">honest tradeoff: far-feeder nodes sag to
        <b>residual undervoltage</b> (purple, 435 events) &mdash; fewer batteries discharge at once. Known, a tuning target; not the herding failure.</span>
      </div>
    </div>
  </div>
